...
(function () {
    ...
    const I18N = {
        fr: {
            ...
            'hero.baseline':    "Je conçois et développe des applications web et mobiles, du backend au mobile.",
            ...
            'about.p3':            "Je suis autonome, curieuse et rigoureuse. Je change d'outil quand un problème le demande, et j'apprends vite ce qui manque. Mon objectif : rejoindre une équipe où l'on construit des produits utiles, avec exigence et bienveillance.",
            ...
            'skills.title.rest':   '— ce que je maîtrise',
            'skills.lead':         "Les technologies avec lesquelles j'ai construit des projets réels, du prototype à la mise en ligne.",
            ...
            'path.cpge.title':     "Classe préparatoire aux Grandes Écoles d'Ingénierie",
            'path.cpge.place':     'Cycle préparatoire — filière polytechnique',
            ...
            'lang.fr':             'Français',
            'lang.fr.level':       'Intermédiaire supérieur (B2)',

            'contact.title.em':    'Écrivons-nous',
            'contact.lead':        "Un stage, un poste junior, une mission ou juste un mot ? Je réponds à chaque message.",
            'contact.location':    'Basée à Nouakchott, Mauritanie · disponible à distance.',

            'footer.copy':         '© 2026 · Écrit à la main à Nouakchott.',
        },
        ...
        en: {
            ...
            'hero.baseline':    'I design and build web and mobile applications, from backend to mobile.',
            ...
            'about.p3':            "I'm independent, curious and thorough. I switch tools when a problem calls for it, and I quickly learn what's missing. My goal: to join a team where we build useful products, with rigor and kindness.",
            ...
            'skills.title.rest':   '— what I master',
            'skills.lead':         "The technologies I've used to build real projects, from prototype to production.",
            ...
            'path.cpge.title':     'Preparatory class for Engineering Grandes Écoles',
            'path.cpge.place':     'Preparatory cycle — polytechnic track',
            ...
            'lang.fr':             'French',
            'lang.fr.level':       'Upper intermediate (B2)',

            'contact.title.em':    "Let's talk",
            'contact.lead':        'An internship, a junior role, a mission or just a word? I answer every message.',
            'contact.location':    'Based in Nouakchott, Mauritania · open to remote.',

            'footer.copy':         '© 2026 · Handcrafted in Nouakchott.',
        },
        ...
        ar: {
            ...
            'hero.baseline':    'أصمّم وأطوّر تطبيقات الويب والهاتف، من الخادم إلى واجهة المستخدم.',
            ...
            'about.p3':            'أنا مستقلة، فضولية ودقيقة. أغيّر الأدوات حين تتطلب المشكلة ذلك، وأتعلّم بسرعة ما ينقصني. هدفي: الانضمام إلى فريق نبني فيه منتجات مفيدة، بجدية ولطف.',
            ...
            'skills.title.rest':   '— ما أُتقنه',
            'skills.lead':         'التقنيات التي بنيتُ بها مشاريع حقيقية، من النموذج الأولي إلى الإطلاق.',
            ...
            'path.licence.note':   'مشروع التخرج: كولية — منصّة جامعية متكاملة.',
            'path.cpge.title':     'السنة التحضيرية للمدارس الهندسية الكبرى',
            'path.cpge.place':     'المرحلة التحضيرية — الشعبة البوليتقنية',
            ...
            'lang.fr':             'الفرنسية',
            'lang.fr.level':       'متوسّط عالٍ (B2)',

            'contact.title.em':    'لنتحدث',
            'contact.lead':        'تدريب، وظيفة، مهمة أو مجرّد كلمة؟ أردّ على كل رسالة.',
            'contact.location':    'مقيمة في نواكشوط بموريتانيا · متاحة للعمل عن بُعد.',

            'footer.copy':         '© 2026 · صُنع بيدين في نواكشوط.',
        },
    };
